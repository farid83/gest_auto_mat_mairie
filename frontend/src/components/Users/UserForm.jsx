...
const UserForm = ({ open, onClose, onSave, initialData, isLoading }) => {
    ...
    const { data: services } = useQuery({
        queryKey: ['services', form.service_id],
        queryFn: () =>
            form.service_id
                ? servicesService.getServicesByDirection(form.service_id)
                : Promise.resolve([]),
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    */}
                    <Select
                        ...
                        onValueChange={(value) => handleChange({ target: { name: 'service_id', value, type: 'select' } })}
                    >
                        <SelectTrigger>
